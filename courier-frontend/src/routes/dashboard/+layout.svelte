    ...
    <div class="dashboard-layout">
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <div class="sidebar-footer" style="margin-top: auto; padding: 1rem 1.5rem; border-top: 1px solid var(--border-color); display: flex; flex-direction: column; gap: 0.5rem;">
                    <button 
                        onclick={() => auth.logout()} 
                        class="sidebar-link" 
                        style="padding: 0.5rem 0; border: none; background: none; width: 100%; cursor: pointer; color: var(--danger);"
                    >
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
